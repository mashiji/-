...
if __name__=="__main__":
    ...
    print('载入训练数据...')
    t=time()
    data=pd.read_csv(r'C:\Users\mashiji\Desktop\MNIST.train.csv',header=0,dtype=np.int)
    ...
    print('载入测试数据...')
    t = time()
    data_test = pd.read_csv(r'C:\Users\mashiji\Desktop\MNIST.test.csv', header=0, dtype=np.int)
